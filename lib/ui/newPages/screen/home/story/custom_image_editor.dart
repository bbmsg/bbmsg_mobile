...
class CustomImageEditorPro extends StatefulWidget {
  final Color appBarColor;
  final Color bottomBarColor;
  CustomImageEditorPro({this.appBarColor, this.bottomBarColor});
...
class _ImageEditorProState extends State<CustomImageEditorPro> {
  // create some values
                ...
                onPressed: () {
                  ...
                  screenshotController
                    ...
                    image.copy(paths.path +
                        ...
                        '.png');
                    await creatstory(image, '' + '.', true).then((value) {
                      getstory('30');
                    });
                    Get.offAll(InstaHome(0));
                  }).catchError((onError) {
                    print(onError);
                  });
                }),
