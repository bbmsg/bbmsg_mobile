...
// class Commentbyidd extends StatefulWidget {
//   final int commentidindex;
//   final int numofcomment;
//   Commentbyidd(this.commentidindex, this.numofcomment, {Key key})
//       : super(key: key);
...
// class _CommentbyidState extends State<Commentbyidd> {
...
//                       onTap: () {
//                         Get.to(PostDetails(widget.commentidindex));
//                       },
//                       child: Flexible(
//                         child: Container(
